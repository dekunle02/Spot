WELCOME_MESSAGE = "Hi there. My name is Spot 🚀. I was created by Samad. I can help you create your NES timesheets. To get started type **/setup**. Do not forget to include the /"


FIRST_NAME_ASK = "Tell me your first name? e.g **Ciroma**"
LAST_NAME_ASK = "And your last name? e.g **Adekunle**"
NAME_ERROR = "🤔 Not sure about that.. names usually contain only letters. Try again"

HOSPITAL_NAME_ASK = "Where do you work? e.g **Nuffield Taunton**"
HOSPITAL_NAME_ERROR = "I'm familiar with only hospital names that contain only alphabets. Want to try that again? 🤷🏾‍♂️"

START_DATE_ASK = "When did your shift start? For example, type **20-5-2021** if it started on the 20th of May in 2021. Do not add any other letters or numbers 🙂"
...
DURATION_ERROR = "Send a digit e.g **3**"

SIGNATURE_ASK = "Send a picture of your signature. I will use this to sign your timesheets on your behalf."
SIGNATURE_ERROR = "You have to send a picture 👨🏾‍🦯"

DISTURBANCE_ASK = "Would you like to add a Night disturbance?👀 Answer with **yes** or **no**"
DISTURBACE_ASK_ERROR = "You have to answer with either **yes** or **no**"
...
DISTURBANCE_DAY_ERROR = "You have to enter a digit. e.g **4**"

DISTURBANCE_TIME_ASK = "What time were you were called? Do not forget to give your time in 24hrs format"
DISTRUBANCE_TIME_ERROR = "If you mean 4am you should type **04:00**"
...
EDIT_MESSAGE = "If you do not wish to change a value type **skip**"
...
EDIT_SIGNATURE = "Send a photo of your new signature"
...
HELP_MESSAGE = f"Typing **/help** always shows this message"\
                ...
                f"To change your information, e.g first name or signature type **/edit**"\
                f"To restart at any time, type **/bye**"\
                f"To delete all your info, type **/delete**"


REPEAT_ERROR_MESSAGE = "Hmm. I still don't understand. You can always type /help. Do not forget to include the /" 

LOG_COMMAND_BASE = "Here are the logs boss! 🙇🏾‍♂️"
